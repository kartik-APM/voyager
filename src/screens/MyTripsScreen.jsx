        ...
        <main className="flex-1 lg:ml-64 p-8 bg-surface">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              <div className="group relative bg-surface-container-lowest rounded-md overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col h-full cursor-pointer" onClick={() => navigate('/builder')}>
                <div className="aspect-[16/10] overflow-hidden relative">
                  <img alt="Paris view" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCMtR9u5kWcdPfE4yZsJmTxECPujnBQuYkRv_5rpHjoUimDls1AwRTo_TNIxUPTDTQfHeaUk7oNGuOcI-QZ6eVicReC67DKSelsMZ3FFcXV2NjFiGJ4J6JRlym6lbdrIyo6eFFX20-GsT3_pFpNfZtxfV34SRQBO2pRArlxEqNF3qJXl5YzKDUXAG6qHUZV0pIrftLIsnh3GyM-fFbrJvsc2qzFpD9W9yhaDhSgB_aLVbhTphZNJP3oie28sJUbrFWtYo8mdG337nA" />
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/80 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest text-primary">Future</span>
                  </div>
                </div>
                <div className="p-6 flex flex-col flex-1">
                  <h3 className="text-2xl font-serif mb-1 -translate-y-4 group-hover:-translate-y-6 transition-transform bg-white/90 backdrop-blur-md p-4 rounded-md inline-block self-start shadow-sm">Summer in Paris</h3>
                  <div className="flex items-center gap-2 text-slate-400 text-xs mb-6">
                    <span className="material-symbols-outlined text-sm">calendar_month</span>
                    <span>July 15 - July 28, 2024</span>
                  </div>
                </div>
              </div>
